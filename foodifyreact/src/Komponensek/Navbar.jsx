...
const Navbar = ({ token, setToken, logged, setLogged, onSearch }) => {
  ...
  const isSearchActive = location.pathname.includes("/hamburgerlista")|| location.pathname.includes("/pizzalista")|| location.pathname.includes("/magyarlista")|| location.pathname.includes("/amerikailista")|| location.pathname.includes("/olaszlista")|| location.pathname.includes("/gyroslista")|| location.pathname.includes("/azsiailista")|| location.pathname.includes("/salataklista") || location.pathname.includes("/desszertlista") || location.pathname.includes("/rendeles");
